...
class light_jammer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "light_jammer")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 2500000, 100000, window.WIN_HAMMING, 2))
...
def main(top_block_cls=light_jammer, options=None):
